...
const Header = () => {
    ...
    const logout = () => {
        ...
        let firstLetterOfUserName = token && localStorage.getItem('name')  ? localStorage.getItem('name').charAt(1) : ''
                                ...
                                <div className='flex items-center gap-2 group'>
                                    <LazyLoad>
                                        {firstLetterOfUserName ? (
                                            <div
                                                className='bg-blue-700 w-8 h-8 sm:w-10 sm:h-10 text-center text-white  flex items-center justify-center font-semibold  rounded-[50%] '>
                                                <p>{firstLetterOfUserName.toUpperCase() || userName.charAt(0).toUpperCase()}</p>
                                            </div>) : (<img className='w-10' src={assets.user} alt=""/>) }
                                    ...
                                    <div
                                        className='absolute top-0 cursor-pointer  pt-10 text-base font-medium text-gray-600 z-20 top-5 right-0 hidden group-hover:block'> {/* dropDown of input */}
