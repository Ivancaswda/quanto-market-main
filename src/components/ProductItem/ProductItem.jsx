...
const ProductItem = ({id, image, name, price, bestseller, hashTags}) => {
    ...
    // Получаем количество отзывов для текущего продукта из localStorage


    const {getReviewData, reviews, loading} = useContext(ShopContext)
    return (
        <div className='text-gray-700 px-12 py-2 sm:px-2 sm:py-1 cursor-pointer flex flex-col  w-100 no-underline hover:no-underline
        ...
        '
            ...
            <Link  className="hover:no-underline hover:text-current" to={`/product/${id}`}>
                ...
                <div className='flex items-center gap-1 mt-2'>
                    ...
                    <p className='pl-2 text-sm'>( Отзывов)</p>
                </div>
            </Link>
