    ...
    return (
        <div className='my-10'>
            <div className='text-center py-8 text-3xl' style={{}}>
                <h1 className='block sm:flex items-center justify-center gap-2 mr-auto ml-auto'><b>Наши</b>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-10 mt-20 gap-y-6'>
                    {
                        latestProducts.map((item, index) => (
                            <ProductItem key={index} id={item._id} image={item.image} name={item.name}
                                         price={item.price} bestseller={item.bestseller} hashTags={item.hashTags}/>
                        ))
                    }
                </div>
            ...
            <div className='text-center py-8 text-3xl' style={{}}>
                <h1 className='block sm:flex   items-center justify-center gap-2 mr-auto ml-auto'><b>Наши товары</b>

                    <button
                        className="relative text-white font-semibold py-1 mt-2  px-3 rounded-3xl bg-red-500 border-[3px] border-transparent overflow-hidden">
