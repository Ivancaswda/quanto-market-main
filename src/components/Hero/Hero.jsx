                ...
                <div className="carousel-inner">
                    <div className="carousel-item active rounded-2xl">
                      ...
                      <img
                        ...
                        >
                            <h5 className="text-3xl sm:text-5xl md:text-7xl font-bold text-white" style={{ textShadow: '5px 5px 20px black', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                Создавай
                            </h5>
                        </div>
                    </div>
