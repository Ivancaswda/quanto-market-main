        ...
        <div>
            ...
            <div className="my-20 flex flex-col md:flex-row gap-16">
                ...
                <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
                    <p>
                        QuantoMarket был задуман как инновационный интернет-ресурс,
                        объединяющий широкий спектр товаров и услуг в одном месте, предоставляя
                        пользователям доступ к современным решениям и товарам от проверенных поставщиков.
                        Мы предлагаем простоту, удобство и надежность в поиске и приобретении товаров, включая
                        специализированные товары для бизнеса, а также интересные предложения для частных покупателей.
                    </p>
                    <p>
                        Основной акцент нашего проекта —
                        на технологии и инновации, поэтому
                        мы гарантируем высокое качество обслуживания,
                        быстрое обновление ассортимента и максимально удобные условия для пользователей.
                        Мы стремимся к тому, чтобы QuantoMarket
                        стал надежным партнером в вашем цифровом пространстве.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full" style={{ height: '100vh' }}>
                ...
                <div className="w-full h-full relative bg-cover bg-center imagedd">
                    ...
                    <div id="inject2" className="absolute top-0 left-0 w-full h-full bg-black opacity-50 z-20">
