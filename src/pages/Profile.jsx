            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] mt-3 gap-y-2.5 text-neutral-700'>
                    ...
                    { isEdit ?(
                        ...
                        <p className='text-blue-400'>{userData.email || 'Не указано'}</p>
                    )}
                    ...
                    <p className='font-medium'>Телефон:</p>
                    {
                        ...
                        }} type="text"/> : <p className='text-blue-400'>{userData.phone || 'Не указано'}</p>
                    }
                    <p className='font-medium'>Адрес:</p>
                    {
                        isEdit ?
                            ...
                            : <p>
                                {userData.address.line1 || 'Не указано'}
                                <br/>
                                {userData.address.line2 || 'Не указано'}
                            </p>
                    }
