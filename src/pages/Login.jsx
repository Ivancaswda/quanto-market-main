...
const Login = () => {
    ...
    async function handleGoogleLogin() {
        ...
        try {
            ...
            // Send user data to backend for sign-up/login
            const response = await axios.post(backendUrl + '/api/user/google-auth', {
                name: user.displayName,
                email: user.email,
                profilePicture: user.photoURL, // Sending profile picture
            });
    ...
    return (
        <div className='w-100  ' >
            { isAuthenticating ? (
                ...
                <form id='bgshka' onSubmit={onSubmitHandler}
                      className='min-h-[80vh] flex items-center relative justify-center'>
